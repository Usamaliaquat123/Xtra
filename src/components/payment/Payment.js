...
<div
  ...
  >
    ...
    <div class='row'>
      ...
      <div class='row'>
        <div class='col-sm-6 col-md-6'><div className='paymentMonthHeading'>
        <p>EXPIRATION</p>
      </div></div>
      ...
      <div class='row'>
        ...
        <div class='col-sm-6 col-md-6'>
          <div onClick={this.handleSubmit()}  className='paymentProcessBtn'>Process Payment</div>
        </div>
      </div>
    </div>
          </div>
          <div class='col-sm-12 col-md-6'>
            <div className='containerStyleLeftHead'><p>GIVE HOPE TO<br /> THOSE WHO <br />NEED IT MOST</p></div>
          </div>
          </div>
    </div>
