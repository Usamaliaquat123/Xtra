          ...
          <div className="row">
            <div className="col-sm-12 col-md-4">
              <div className='cardCcontainer'>
                ...
                <z href="/Schools" className='containerButton'>Read more</z>
              </div>
            </div>
            <div className="col-sm-12 col-md-4">
              <div className='cardCcontainer'>
                ...
                <z href="/Teachers" className='containerButton'>Read more</z>
              </div>
            </div>
            <div className="col-sm-12 col-md-4">
              <div className='cardCcontainer'>
                ...
                <a href="/Schools" className='containerButton'>Read more</a>
              </div>
            </div>
          </div>
        </div>
